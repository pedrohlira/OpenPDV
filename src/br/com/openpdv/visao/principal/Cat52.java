 ...
 * @author Pedro H. Lira
 */
public class Cat52 extends JDialog {

    private static Cat52 cat52;
    private Date inicio;
    private Date fim;
     ...
     */
    public static Cat52 getInstancia() {
        if (cat52 == null) {
            cat52 = new Cat52();
        }

        cat52.txtDtInicio.setText(null);
        cat52.txtDtFim.setText(null);
        return cat52;
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(329, 127));
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        FiltroGrupo gf = new FiltroGrupo(Filtro.E, fo, dt1, dt2);
                    ...
                    if (sucesso) {
                        JOptionPane.showMessageDialog(cat52, "Arquivos gerados com sucesso!", "Menu Fiscal", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(cat52, "Alguns arquivo não foram gerados!", "Menu Fiscal", JOptionPane.WARNING_MESSAGE);
                    }
                }
            }).start();
