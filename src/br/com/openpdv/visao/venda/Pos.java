 ...
 * @author Pedro H. Lira
 */
public class Pos extends javax.swing.JDialog {
    ...
    private Pos() {
        ...
        log = Logger.getLogger(Pos.class);
        initComponents();
     ...
     */
    public static Pos getInstancia(AsyncCallback<EcfPagamento> async, double total) {
        if (pos == null) {
            pos = new Pos();
        }

        pos.cmbTipo.setSelectedIndex(-1);
        pos.txtValor.setValue(total);
        pos.spParcela.setValue(1);
        pos.txtDoc.setText("");
        pos.txtDoc.setDocument(new TextFieldLimit(10));
        pos.async = async;
        pos.total = total;
        return pos;
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(375, 155));
    ...
    private void carregaTipos() {
        try {
            ...
            FiltroTexto ft = new FiltroTexto("ecfPagamentoTipoCodigo", ECompara.DIFERENTE, Util.getConfig().getProperty("ecf.cheque"));
            FiltroGrupo gf = new FiltroGrupo(Filtro.E, fb, ft);
