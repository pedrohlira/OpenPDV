...
CREATE TABLE ecf_nota_eletronica (
  ...
  CONSTRAINT FK_ecf_nota_eletronica_2 FOREIGN KEY (sis_empresa_id) REFERENCES sis_empresa (sis_empresa_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE ecf_nota (
  ...
  CONSTRAINT FK_ecf_nota_2 FOREIGN KEY (sis_empresa_id) REFERENCES sis_empresa (sis_empresa_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE ecf_pagamento (
  ...
  ecf_pagamento_nsu varchar(12) NOT NULL,
