...
CREATE TABLE ecf_nota_produto (
    ...
    ecf_nota_produto_barra character varying(30) DEFAULT NULL::character varying,
...
CREATE TABLE ecf_troca_produto (
    ...
    prod_produto_id integer NOT NULL,
    prod_embalagem_id integer NOT NULL,
    ecf_troca_produto_barra character varying(30) DEFAULT NULL::character varying,
...
CREATE TABLE ecf_venda_produto (
    ...
    prod_embalagem_id integer NOT NULL,
    prod_produto_id integer NOT NULL,
    ecf_venda_produto_barra character varying(30) DEFAULT NULL::character varying,
...
CREATE TABLE prod_grade (
    ...
    prod_produto_id integer NOT NULL,
    prod_grade_barra character varying(30) NOT NULL,
...
CREATE TABLE prod_preco (
    ...
    prod_preco_barra character varying(30) DEFAULT NULL::character varying,
    ead character varying(260) NULL
);
...
CREATE TABLE prod_produto (
    ...
    prod_produto_descricao character varying(120) NOT NULL,
    prod_produto_referencia character varying(60) NOT NULL,
