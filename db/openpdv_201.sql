...
CREATE TABLE ecf_nota_produto (
  ...
  prod_produto_id int(11) NOT NULL,
  prod_embalagem_id int(11) NOT NULL,
  ecf_nota_produto_barra varchar(30) NULL DEFAULT NULL,
...
CREATE TABLE ecf_troca_produto (
  ...
  prod_produto_id int(11) NOT NULL,
  prod_embalagem_id int(11) NOT NULL,
  ecf_troca_produto_barra varchar(30) NULL DEFAULT NULL,
...
CREATE TABLE ecf_venda_produto (
  ...
  prod_embalagem_id int(11) NOT NULL,
  prod_produto_id int(11) NOT NULL,
  ecf_venda_produto_barra varchar(30) NULL DEFAULT NULL,
